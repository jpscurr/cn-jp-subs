...
LANGUAGES = {
    "ja": {
        ...
        # 音乐模式专用。唱起来的日文，Whisper 容易按说话的节奏去断句，
        # 先告诉它这是歌词，断句会跟着乐句走。
        "music_prompt": "以下は日本語の歌の歌詞です。歌詞をそのまま書き起こしてください。",
    },
    "zh": {
        "name": "Chinese",
        "native": "中文",
        ...
        # 音乐模式专用。唱腔会把声调抹平，说唱还常带方言，这时候提示词
        # 说"句子"反而误导——直说是歌词，让它别硬往规整的书面句子上凑。
        "music_prompt": "以下是一首中文歌曲的歌词，请用简体中文逐句转写。",
    },
}
